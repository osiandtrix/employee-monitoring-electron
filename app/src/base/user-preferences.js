...
const preferences = {
  ...
  updateNotification: {
    ...
    description: 'Notify about Time Attendance Desktop updates available on launch',
    default: true,
    frontend: {
      element: 'toggle',
  ...
  usageStatistics: {
    ...
    description: 'Share usage statistics with Time Attendance Developers. Statistics include only versions of Time Attendance Desktop, Operating System, and backend installation ID. We don\'t collect any personal data, and all collected statistics will be used only to better understand how we can improve the desktop application experience.',
    default: true,
    frontend: {
      element: 'toggle',
  ...
  errorReporting: {
    ...
    description: 'When an error occurs, Time Attendance Desktop will send an anonymized report to the development team with details concerning that error. Application restart is required to apply the new sharing policy.',
    default: true,
    frontend: {
      element: 'toggle',
